import { CarOutlined, GiftOutlined, SafetyCertificateOutlined, ShoppingCartOutlined, UserOutlined } from "@ant-design/icons";
            ...
            <div style={{ marginTop: '24px' }}>
                ...
                <Row gutter={[16, 16]} style={{ marginTop: '24px' }}>
                    <Col xs={24} sm={24} md={12} lg={6} style={{ textAlign: 'center' }}>
                        ...
                        <Typography.Title level={3}>Аюулгүй бүтээгдэхүүн</Typography.Title>                  
